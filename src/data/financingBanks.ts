...
export const OFFICIAL_FINANCING_BANKS: FinancingBank[] = [
  ...
  },
  {
    ...
    description: 'Simulação rápida para imóveis residenciais e comerciais no portal oficial do Banco Santander.',
    buttonText: 'SIMULAR NO SANTANDER',
    simulatorUrl: 'https://www.santander.com.br/',
  ...
  },
  {
    ...
    description: 'Consulte prazos de até 35 anos, valores de amortização e condições personalizadas no portal oficial do Bradesco.',
  ...
  },
  {
    ...
    description: 'Simule online o valor da parcela e opções de financiamento no portal oficial do Itaú.',
    buttonText: 'SIMULAR NO ITAÚ',
    simulatorUrl: 'https://www.itau.com.br/',
  ...
  },
  {
    ...
    description: 'Faça a simulação no portal oficial de Crédito Imobiliário do Banco do Brasil.',
    buttonText: 'SIMULAR NO BANCO DO BRASIL',
    simulatorUrl: 'https://www.bb.com.br/site/pra-voce/financiamentos/financiamento-imobiliario/',
