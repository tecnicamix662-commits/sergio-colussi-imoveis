  ...
  return (
    <div className="pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-card-gold text-gold-300 text-xs font-semibold uppercase tracking-widest border border-gold-500/30 shadow-glow-gold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="bg-white rounded-3xl p-8 border border-cream-300 shadow-soft space-y-6">
            <h3 className="font-serif text-2xl font-bold text-stone-900 tracking-tight border-b border-cream-300 pb-3">
              Por Que Vender / Alugar Conosco?
            </h3>

            <div className="space-y-4 text-xs font-medium">
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-cream-100/80 border border-cream-300">
                <CheckCircle2 className="w-5 h-5 text-gold-600 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Produção Fotográfica Profissional</h4>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-cream-100/80 border border-cream-300">
                <CheckCircle2 className="w-5 h-5 text-gold-600 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Compradores Pré-Qualificados</h4>
              ...
              <div className="flex items-start gap-3 p-3.5 rounded-xl bg-cream-100/80 border border-cream-300">
                <CheckCircle2 className="w-5 h-5 text-gold-600 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-stone-900 text-sm">Segurança Jurídica &amp; Atendimento Direto</h4>
            ...
            <div className="pt-2 border-t border-cream-300 text-center space-y-3">
              ...
              <a
                ...
                className="w-full py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md"
              >
        ...
        <div className="lg:col-span-7">
          <div className="bg-white rounded-3xl p-8 sm:p-10 border border-cream-300 shadow-soft space-y-6">
            <h3 className="font-serif text-2xl font-bold text-stone-900 tracking-tight border-b border-cream-300 pb-3 flex items-center gap-2">
            ...
            {isSubmitted ? (
              <div className="p-8 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-center space-y-4 animate-in fade-in duration-300">
                ...
                <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-auto px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md"
                  >
                    <Phone className="w-4 h-4" />
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 rounded-xl bg-stone-100 text-stone-800 hover:text-stone-900 border border-cream-300 text-xs font-bold"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-5 text-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <User className="w-4 h-4 text-gold-600 absolute left-3 top-3.5" />
                      <input
                        type="text"
                        required
                        ...
                        className="w-full bg-cream-100/70 border border-cream-300 rounded-xl pl-9 pr-4 py-3 text-stone-900 font-semibold text-xs placeholder-stone-400 focus:outline-none focus:bg-white focus:border-gold-500 shadow-sm transition-all"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Phone className="w-4 h-4 text-gold-600 absolute left-3 top-3.5" />
                      <input
                        type="tel"
                        required
                ...
                <div>
                  ...
                  <div className="relative">
                    <Mail className="w-4 h-4 text-gold-600 absolute left-3 top-3.5" />
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-cream-100/70 border border-cream-300 rounded-xl px-4 py-3 text-stone-900 font-semibold text-xs focus:outline-none focus:bg-white focus:border-gold-500 shadow-sm transition-all"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="Outra">Outra região do ABC</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-cream-100/70 border border-cream-300 rounded-xl px-4 py-3 text-stone-900 font-semibold text-xs placeholder-stone-400 focus:outline-none focus:bg-white focus:border-gold-500 shadow-sm transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-cream-300 hover:border-gold-500 rounded-2xl p-6 text-center cursor-pointer bg-cream-100/50 transition-colors relative">
                    <input
                      type="file"
                      multiple
                      accept="image/*"
                    ...
                    />
                    <UploadCloud className="w-8 h-8 text-gold-600 mx-auto mb-2" />
                    <span className="text-stone-900 font-bold text-xs block">Clique ou arraste fotos aqui</span>
                    <span className="text-[11px] text-stone-600 block">PNG, JPG ou WEBP (Max 10MB por foto)</span>
                  </div>
                  ...
                  {imageFiles.length > 0 && (
                    <div className="flex items-center gap-3 overflow-x-auto py-2">
                      {imageFiles.map((img, idx) => (
                        <div key={idx} className="relative h-16 w-20 shrink-0 rounded-lg overflow-hidden border border-cream-300 group">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gold-gradient text-stone-950 font-bold text-xs uppercase tracking-wider hover:brightness-110 transition-all shadow-glow-gold flex items-center justify-center gap-2"
                >
